 ...
 * for a final authoritative baseline of 57 records.
 ...
 * installation with no stored override loads these 57 records.
 */
export const BASELINE_MODES: Mode[] = AUTHORITATIVE_MODES;

/** The approved library is committed to the repository. */
export const BASELINE_COMPLETE = BASELINE_MODES.length === 57;
...
export const SCHEMA_VERSION = "v4.authoritative-57";
