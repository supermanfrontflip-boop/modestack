...
const SITUATION_TYPES: SituationType[] = [
  ...
  },
  {
    ...
    signals: ["dispute", "disagreement", "argument", "complaint about", "tension", "resolve", "de-escalate", "team conflict", "family conflict", "coworker conflict", "mediator"],
    primary: "diplomat",
...
"most likely to rule",
"likely to rule",
"judge is most likely",
"judicial outcome",
"how a judge","legal", "lawsuit", "court", "magistrate", "judge", "statute", "case law", "motion", "filing", "attorney"],
    primary: "owl",
supporting: ["shadow", "glove"],
  ...
  {
    type: "Investigation",
    signals: ["investigate", "investigation", "what really happened", "look into", "dig into", "uncover", "fraud", "leak", "witness statements conflict",
"statements conflict",
"timeline does not match",
"timeline doesn't match",
"determine what most likely happened",
...
preferredSupport: ["shadow", "glove"],
  ...
  },
  {
    ...
    preferredPrimary: ["owl", "glove"],
preferredSupport: ["shadow", "glove", "owl"], 
  ...
  },
  {
    ...
    preferredSupport: ["diplomat", "wild-bird-seed", "whaler", "architect", "hawk", "alien", "apex"],
    avoid: ["raven", "gomer-pyle"],
    deliverableRules: [
      { rx: /client acquisition|acquisition plan|first ten paying|first 10 paying|paying law firm clients|law firm clients/, label: "Client Acquisition Plan" },
